...
public final class CaptchaManager {
	 ...
	 * @return 验证码字符串
	 */
	public String generateTextCode(int type, int length, String exChars) {
	 ...
	 * @return 图片缓存对象
	 */
	public BufferedImage generateImageCode(String textCode, int width, int height, int interLine, boolean randomLocation, Color backColor, Color foreColor, Color lineColor) {
	 ...
	 * @return 图片缓存对象
	 */
	public BufferedImage generateImageCode(int type, int length, String exChars, int width, int height, int interLine, boolean randomLocation, Color backColor, Color foreColor, Color lineColor) {
