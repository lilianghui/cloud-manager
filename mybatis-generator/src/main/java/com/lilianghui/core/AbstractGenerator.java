...
public abstract class AbstractGenerator extends NameSpace {
    ...
    public final void generator() throws Exception {
        ...
        root.putAll(getNameSpaceMap(config.getIgnorePrefix()==null?"":config.getIgnorePrefix()));
...
//		String importUpdatable="tk.mybatis.mapper.annotation.Updatable";
        ...
        if (table.getPkColumn() != null && table.getPkColumn().isIdentity() && "String".equals(table.getPkColumn().getJavaType())) {
